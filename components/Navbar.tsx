    ...
    return (
        <header className="h-screen">
            <div className="flex flex-col items-center w-60 h-full  overflow-hidden text-white bg-violet-500 ">
                ...
                <div className="flex items-center justify-center w-full h-16 mt-auto bg-violet-700 hover:bg-violet-900" >
                    {!session?.user ?
                        ...
                        <>
                            <DropdownMenu>
                                <DropdownMenuTrigger className="select-none flex items-center space-x-4 border-none w-full h-full justify-center">
                                    <Avatar>
                                ...
                                <DropdownMenuContent>
                                    ...
                                    <DropdownMenuItem onClick={() => setProfile(!isProfile)} className="cursor-pointer">
                                        <span>Profile</span>
                                    </DropdownMenuItem>
                                    ...
                                    <DropdownMenuItem className="p-0">
                                        <ButtonLogout className="w-full h-full m-0 border-0" >
